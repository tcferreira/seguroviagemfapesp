...
class Depoimentos extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('depoimentos_m');
        $this->model = $this->depoimentos_m;
    }
    ...
    public function upload_image()
    {
        ...
        $uploadPath = dirname(FCPATH) . DIRECTORY_SEPARATOR . 'userfiles' . DIRECTORY_SEPARATOR . 'depoimentos' . DIRECTORY_SEPARATOR;
        ...
        if ($this->upload->do_upload('file')) {
            ...
            echo json_encode([
                ...
                'url'       => $rootBase . 'userfiles/depoimentos/' . $data['file_name'],
