...
<head>
    ...
    <style>
        ...
        [data-sidebar-style="full"][data-layout="vertical"] .menu-toggle .nav-header .brand-logo img { max-width: 30px; }
    </style>
</head>
...
<body data-theme-version="light">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo get_environment('GMAPS_KEY') ?>&libraries=places"></script>
