...
S2.define('select2/i18n/en',[],function () {
  ...
  return {
    ...
    inputTooLong: function (args) {
      ...
      var message = 'Digite no máximo ' + overChars + ' caracteres';
    ...
    inputTooShort: function (args) {
      ...
      var message = 'Digite no mínimo ' + remainingChars + ' caracteres';
    ...
    maximumSelected: function (args) {
      var message = 'Permitido selecionar apenas ' + args.maximum + ' item';
