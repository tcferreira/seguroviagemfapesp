                ...
                <div class="table-responsive">
                    <table class="table color-table info-table">
                        <thead>
                            <tr>
                                <th width="20">#</th>
                                <th class="text-center" width="20"><?php echo T_('Ícone'); ?></th>
                                <th><?php echo T_('Nome'); ?></th>
                                <th class="text-center"><?php echo T_('Status'); ?>
                        ...
                        <?php foreach ($items as $key => $item){ ?>
                            <tr data-id="<?php echo $item->id; ?>">
                                ...
                                <td class="text-center" data-title="<?php echo T_('Ícone'); ?>">
                                    <i class="<?php echo $item->icon; ?>"></i>
                                </td>
                                <td class="text-middle" data-title="<?php echo T_('Nome'); ?>"><?php echo $item->name; ?></td>
