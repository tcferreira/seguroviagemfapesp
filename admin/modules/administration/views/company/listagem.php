                ...
                <div class='table-responsive'>
                    <table class='table color-table info-table'>
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php echo T_('Razão Social');?></th>
                        ...
                        <?php foreach ($items as $key => $item){ ?>
                            <tr data-id='<?php echo $item->id; ?>'>
                                ...
                                <td class='text-middle' data-title="<?php echo T_('Razão Social'); ?>"><?php echo $item->company_name; ?></td>
                                <td class='text-center' data-title="<?php echo T_('Status'); ?>">
                                    <?php echo statusLabel($item->status, $item->id); ?>
                                </td>
                                <td class='text-right' nowrap data-title="<?php echo T_('Ações'); ?>">
