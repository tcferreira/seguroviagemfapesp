...
/* Custom Constants */
defined('SITE_NAME')     or define('SITE_NAME', get_environment('SITE_NAME') ? get_environment('SITE_NAME') : 'Seguro Viagem FAPESP');
defined('DS')            or define('DS', DIRECTORY_SEPARATOR);
defined('ADMIN_GROUP')   or define('ADMIN_GROUP', 1);
defined('RECEITAWS_KEY') or define('RECEITAWS_KEY', get_environment('RECEITAWS_KEY') ? get_environment('RECEITAWS_KEY') : '');
defined('GMAPS_KEY')     or define('GMAPS_KEY', get_environment('GMAPS_KEY') ? get_environment('GMAPS_KEY') : '');
