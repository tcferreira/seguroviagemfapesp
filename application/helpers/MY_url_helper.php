...
if (!function_exists('assets')) {
    function assets($file = '', $module = false)
    {
        ...
        return base_url("application/modules/{$module}/assets/{$file}");
    }
}
...
if(!function_exists('load_svg')){
    function load_svg($file = '', $module = FALSE, $userfiles = FALSE)
    {
        ...
        if(!$userfiles && file_exists(FCPATH."application/modules".DS."{$module}".DS."assets".DS."svg".DS."{$file}"))
        {
            $contents = file_get_contents(FCPATH."application/modules".DS."{$module}".DS."assets".DS."svg".DS."{$file}");
        }
        elseif(!$userfiles && file_exists(FCPATH."application/modules".DS."{$module}".DS."assets".DS."svg".DS."{$file}.svg"))
        {
            $contents = file_get_contents(FCPATH."application/modules".DS."{$module}".DS."assets".DS."svg".DS."{$file}.svg");
        }
