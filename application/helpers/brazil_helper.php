...
function formatarDataEvento($dataInicio) {
    ...
    // Formatar a data
    $dataFormatada = strftime('%A, %d de %b', strtotime($dataInicio));

    // Retornar a data formatada com a primeira letra do dia da semana em maiúsculo
    return ucfirst($dataFormatada);
}
