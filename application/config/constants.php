...
if (!defined('PATH_TO_MODEL')) {
    define('PATH_TO_MODEL', realpath(dirname(FCPATH) . '/admin/modules') ? realpath(dirname(FCPATH) . '/admin/modules') . DS : dirname(FCPATH) . DS . 'admin' . DS . 'modules' . DS);
}
